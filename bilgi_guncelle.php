...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        $mesaj = "Bilgilerinizde herhangi bir değişiklik yapılmadı.";
        $mesaj_tur = "danger";
    } else {
...
<style>
  ...
  main { flex: 1; min-height: calc(100vh - 200px); } /* navbar + footer payı */
</style>
</head>
<body class="bg-light">
...
<main>
  <div class="container my-5" style="max-width: 600px;">
    ...
    <?php if (!empty($mesaj)): ?>
      <div class="alert alert-<?= $mesaj_tur ?> text-center"><?= htmlspecialchars($mesaj) ?></div>
    <?php endif; ?>
