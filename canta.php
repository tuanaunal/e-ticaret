...
$sql = "SELECT * FROM urun WHERE kategori_id = $canta_kategori_id";
...
<head>
  ...
  <meta name="keywords" content="Aksesuar,Çanta">
  <meta name="description" content="Yakamoz Aksesuar’da çanta koleksiyonları">
  <link rel="icon" type="image/png" href="YA-Dükkan Resimleri/icon.png">
  <title>Yakamoz Aksesuar - Çanta</title>
