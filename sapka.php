...
$sql = "SELECT * FROM urun WHERE kategori_id = $sapka_kategori_id";
...
<head>
  ...
  <meta name="keywords" content="Aksesuar,Şapka">
  <meta name="description" content="Yakamoz Aksesuar’da şapkalar">
  <link rel="icon" type="image/png" href="YA-Dükkan Resimleri/icon.png">
  <title>Yakamoz Aksesuar - Şapka</title>
