...
<head>
  ...
  <style>
    /* Sadece sonuç YOKKEN footer'ı biraz aşağıda göster */
    .push-footer-more { padding-bottom: 70vh; } /* 50–80vh arası zevkine göre */
  </style>
</head>
<body>
...
<div class="container <?= $hasResults ? 'my-5' : 'mt-5 mb-0 push-footer-more' ?>">
  <h2 class="text-center mb-4">
    "<?= htmlspecialchars($arama) ?>" için arama sonuçları
  </h2>

  <div class="row gx-3 gy-4 <?= $hasResults ? 'justify-content-start' : 'justify-content-center' ?>">
    <?php if ($hasResults): ?>
        ...
        <div class="col-6 col-md-4 col-lg-3 mb-4">
          <div class="card product-card position-relative">
            ...
            <div class="card-body product-card-body d-flex flex-column">
              ...
              <p class="card-text mb-auto"><?= htmlspecialchars($urun['fiyat']) ?> TL</p>
