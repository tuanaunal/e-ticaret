            ...
            <form action="uye_kayit.php" method="POST">
              ...
              <div class="form-floating mb-3">
                <input
                  ...
                  required
                  oninvalid="this.setCustomValidity('Lütfen e-posta adresinizi girin.')"
              ...
              <div class="col-12">
                <div class="form-check text-start">
                  <input class="form-check-input" type="checkbox" name="iletisim_izin" id="chkIleti" style="transform: scale(1.5);">
                ...
                <div class="form-check mt-2 text-start">
                  <input
                    ...
                    required
                    oninvalid="this.setCustomValidity('İlerlemek istiyorsanız lütfen bu kutuyu işaretleyin.')"
                    oninput="this.setCustomValidity('')"
                  >
              ...
              <button type="submit" class="btn w-100 mt-3" style="background-color: #000; color: #fff;">Üye Ol</button>
            </form>
          </div>
        </div>
