...
$conn->query("UPDATE siparis SET kargo_firma = 'Yurtiçi Kargo' 
              WHERE kargo_firma IS NULL OR kargo_firma = '' OR kargo_firma = 'Belirtilmedi'");
...
<div class="container-fluid min-vh-100 d-flex justify-content-center align-items-start align-items-md-center py-4">
    <div class="card panel-card p-4">
        <h2 class="mb-4 text-center" style="font-family:'Playfair Display', serif;"> Siparişler</h2>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($is_kargoda): ?>
                                    <a class="btn btn-secondary btn-sm" href="https://www.yurticikargo.com/" target="_blank" rel="noopener">Takip</a>
                                <?php else: ?>
