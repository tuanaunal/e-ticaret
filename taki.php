...
$sql = "SELECT * FROM urun WHERE kategori_id = $taki_kategori_id";
...
<head>
  ...
  <meta name="keywords" content="Aksesuar,Takı,Gözlük,Şapka,Çanta,Saç Aksesuarı">
  <meta name="description" content="Yakamoz Aksesuar’da zarif takılar">
  <link rel="icon" type="image/png" href="YA-Dükkan Resimleri/icon.png">
  <title>Takı - Yakamoz Aksesuar</title>
