...
<div class="container mt-5">
    <h2 class="mb-4 text-center" style="font-family: 'Playfair Display', serif;">Hesabım</h2>

    <div class="card p-4 shadow mx-auto" style="max-width: 500px;">
        <p class="text-center"><strong>Ad Soyad:</strong> <?= htmlspecialchars($uye['ad'] . ' ' . $uye['soyad']) ?></p>
        <p class="text-center"><strong>Telefon:</strong> <?= htmlspecialchars($uye['telefon']) ?></p>
        <p class="text-center"><strong>Doğum Tarihi:</strong> <?= htmlspecialchars($uye['dogum_tarihi']) ?></p>
        <p class="text-center"><strong>E-posta:</strong> <?= htmlspecialchars($uye['email']) ?></p>
        <p class="text-center"><strong>Kayıt Tarihi:</strong> <?= htmlspecialchars($uye['kayit_tarihi']) ?></p>
